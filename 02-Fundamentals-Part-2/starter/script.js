...
// function calcTip(newBill) {
//   for (i = 0; i < newBill.length; i++) {
//     const tip = newBill[i] >= 50 && newBill[i] <= 300 ? newBill[i] * 0.15 : newBill[i] * 0.2;
//     newBill[i] = tip;
//   }
//   return newBill;
// }
...
//   }) is higher than ${mark.bmi > john.bmi ? john.fullName : mark.fullName} (${
